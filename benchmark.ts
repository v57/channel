...
async function startTest(name: string, test: (client: Sender<any>, info: TestingInfo) => Promise<void>) {
...
async function run(client: Sender<any>, info: TestingInfo, ops: number = 100_000) {
